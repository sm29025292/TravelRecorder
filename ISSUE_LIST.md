...
| T44 | 電腦版排版微調（總覽／花費／行程欄寬＋景點庫新增表單版面） | P2 | ★★ | 無 | 待實作 |
...
## T44 電腦版排版微調（總覽／花費／行程欄寬＋景點庫新增表單版面）（P2・★★・依賴：無）

> 狀態：**規格已與擁有者在對話中確認（2026-09-08），尚未實作**。純版面／CSS 寬度調整，
> 無 schema、無 `src/lib` 純函式、無資料變動。擁有者提供多張截圖逐項確認，細節見下。
