...
| T41 | 新增旅程時強制先輸入旅程名稱與日期 | P2 | ★ | T40（同對話框） | 📋 規格已定，待施工 |
| T42 | 新旅程花費預設帶入常用項目（機票×2／飯店／接駁／換匯／保險） | P2 | ★★ | T40（同建立流程） | 📋 規格已定，待施工 |
...
## T41 新增旅程時強制先輸入旅程名稱與日期（P2・★・依賴：T40）📋 規格已定，待施工

> 狀態：**規格已與擁有者拍板（2026-09-07），待下令施工**。設計決定勿再更動。
...
## T42 新旅程花費預設帶入常用項目（P2・★★・依賴：T40）📋 規格已定，待施工
